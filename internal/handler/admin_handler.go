...
func (h *AdminHandler) DeleteCharacter(c *gin.Context) {
	if err := h.service.DeleteCharacter(c.Param("ref")); err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *AdminHandler) DeleteSong(c *gin.Context) {
	if err := h.service.DeleteSong(c.Param("ref")); err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
	response.OK(c, gin.H{"success": true}, nil)
...
func (h *AdminHandler) ListRelations(c *gin.Context) {
	list, err := h.service.ListRelations()
	if err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *AdminHandler) GetRelation(c *gin.Context) {
	item, err := h.service.GetRelation(c.Param("ref"))
	if err != nil {
		response.Error(c, http.StatusNotFound, err.Error())
		return
	}
...
func (h *AdminHandler) CreateRelation(c *gin.Context) {
	var in dto.AdminRelation
	if err := c.ShouldBindJSON(&in); err != nil {
		response.Error(c, http.StatusBadRequest, err.Error())
		return
	}
	item, err := h.service.CreateRelation(in)
	if err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *AdminHandler) UpdateRelation(c *gin.Context) {
	var in dto.AdminRelation
	if err := c.ShouldBindJSON(&in); err != nil {
		response.Error(c, http.StatusBadRequest, err.Error())
		return
	}
	item, err := h.service.UpdateRelation(c.Param("ref"), in)
	if err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *AdminHandler) DeleteRelation(c *gin.Context) {
	if err := h.service.DeleteRelation(c.Param("ref")); err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
	response.OK(c, gin.H{"success": true}, nil)
...
func (h *AdminHandler) DeleteTheme(c *gin.Context) {
	if err := h.service.DeleteTheme(c.Param("ref")); err != nil {
		response.Error(c, http.StatusInternalServerError, err.Error())
		return
	}
	response.OK(c, gin.H{"success": true}, nil)
